...
<section class="SubTop sale">
    <h2>알림공개<span>속 시원한 '진짜' 맞춤형 비교견적, 자동차 세일즈 토탈솔루션 - 오토디자인</span></h2>		
</section>

<section class="boardArea">
    <div class="container">
        <ul class="board_tab">
            <li class="on"><a href="/bbs/board.php?bo_table=sale">할인정보</a></li>
            <li><a href="/bbs/board.php?bo_table=company">회사정보</a></li>
        </ul>
