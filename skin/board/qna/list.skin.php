...
<section class="SubTop review">
    <h2>커뮤니티<span>속 시원한 '진짜' 맞춤형 비교견적, 자동차 세일즈 토탈솔루션 - 오토디자인</span></h2>		
</section>

<section class="boardArea">
    <div class="container">
        <ul class="board_tab">
            <li><a href="/bbs/board.php?bo_table=review">출고후기</a></li>
            <li class="on"><a href="/bbs/board.php?bo_table=qna">질문답변</a></li>
        </ul>
