...
<?php
if($member[mb_level] > "9" && !$view['wr_9']){
	sql_fetch(" update $write_table set wr_9='상담중' where wr_id='{$view['wr_id']}' ");
}
?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">작성일</span>작성일 : <?php echo date("Y-m-d", strtotime($view['wr_datetime'])) ?>
        <span class="sound_only">조회</span><strong style="margin: 0 0 0 10px">조회수 : <?php echo number_format($view['wr_hit']) ?>회</strong>
    ...
    <div id="bo_v_top">
        ...
        <ul class="list_btn_group">
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn listBtn">목록</a></li>
        </ul>
        ...
        <ul class="bo_v_nb">
            ...
            <li class="btn_prv">
                ...
                <a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> <span class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span>
            </li>
            <?php } ?>
            <?php if ($next_href) { ?>
            <li class="btn_next">
                ...
                <?php echo $next_wr_subject;?></a>
                <span class="nb_date">
                <?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span>
                </li>
            <?php } ?>
        </ul>
        <?php } ?>
