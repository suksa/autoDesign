...
<section class="SubTop lesson">
    <h2>레슨공개<span>속 시원한 '진짜' 맞춤형 비교견적, 자동차 세일즈 토탈솔루션 - 오토디자인</span></h2>		
</section>
                    ...
                    <div class="gall_img">
                        ...
                        <?php } else {
                            ...
                            if($thumb['src']) {
                                ...
                                $img_content = '<span class="no_image"><img src="/assets/img/noimg.jpg" alt=""></span>';
                            }
