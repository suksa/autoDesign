...
<section id="bo_w">
    ...
    <div class="write_div">
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="" required class="frm_input required" size="50" maxlength="255" placeholder="계약일">
        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="" required class="frm_input required" size="50" maxlength="255" placeholder="담당자">
    </div>
    <div class="write_div">
        <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="" required class="frm_input required" size="50" maxlength="255" placeholder="서류수령">
        <input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="" required class="frm_input required" size="50" maxlength="255" placeholder="계약차량">
    </div>
